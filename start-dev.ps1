...
function Start-BackgroundProcess {
    ...
    $quotedFilePath = Quote-CmdArgument -Value $FilePath
    $quotedWorkingDirectory = Quote-CmdArgument -Value $WorkingDirectory
    $quotedStdOutPath = Quote-CmdArgument -Value $StdOutPath
    $quotedStdErrPath = Quote-CmdArgument -Value $StdErrPath
    $quotedArguments = (($ArgumentList | ForEach-Object { Quote-CmdArgument -Value $_ }) -join " ")
    $command = "cd /d $quotedWorkingDirectory && $quotedFilePath $quotedArguments 1> $quotedStdOutPath 2> $quotedStdErrPath"
