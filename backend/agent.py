...
SYSTEM_PROMPT = (
    ...
    "6. **McDonald's MCP** - Use the McDonald's tools for mall orders, coupons, stores, meals, and account data. For recent orders, prefer `query_recent_mcd_orders`.\n"
    "7. **Train Ticket Query (12306)** - Use the 12306 MCP tools to look up Chinese train tickets. "
